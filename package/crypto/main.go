...
// AsymKeyPair generates an RSA-OAEP 2048-bit key pair
func AsymKeyPair() (*tCrypt_KeyPair, error) {
...
// AsymEncrypt encrypts data using RSA-OAEP with a base64-encoded public key
func AsymEncrypt(data, publicKeyBase64 string) (string, error) {
...
// AsymDecrypt decrypts data using RSA-OAEP with a base64-encoded private key
func AsymDecrypt(encryptedData, privateKeyBase64 string) (string, error) {
...
// SymGencrypt generates a new AES-256-GCM key and encrypts data
func SymGencrypt(data string) (*tCrypt_SymResult, error) {
...
// SymEncrypt encrypts data using provided AES-256-GCM key and nonce
func SymEncrypt(data, base64Key, base64IV string) (*tCrypt_SymResult, error) {
	// Decode key and IV
...
// SymDecrypt decrypts data using AES-256-GCM with provided key and nonce
func SymDecrypt(encryptedData, base64Key, base64IV string) (string, error) {
