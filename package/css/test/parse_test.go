...
// }
	...
	res_spread := _css.ParsePartial(content_spread, 8)
	// res_condensed := _css.ParsePartial(content_condensed, 8)

	console.Render.Raw("Json 1")
	console.Render.Raw(res_spread)
	console.Render.Raw("---")
	// console.Render.Raw("Json 2")
	// console.Render.Raw(res_condensed)

	// console.Render.Raw(_util.Code_JsonBuild(res_spread, "") == _util.Code_JsonBuild(res_condensed, ""))
}

func Test_Block2(t *_testing.T) {
