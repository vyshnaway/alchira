export function hslToRgb(h, s, l, alpha = 1) {
    s /= 100;
    l /= 100;
    const k = (n) => (n + h / 30) % 12;
...
export function rgbToHsl(r, g, b, alpha = 1) {
    r /= 255;
    g /= 255;
    b /= 255;
...
export function rgbToLab(r, g, b, alpha = 1) {
    r /= 255;
    g /= 255;
    b /= 255;
...
export function lchToRgb(L, C, H, alpha = 1) {
...
export function rgbToLch(r, g, b, alpha = 1) {
...
export function hwbToRgb(h, w, bl, alpha = 1) {
    h = h % 360;
    w /= 100;
    bl /= 100;
...
export function rgbToHwb(r, g, b, alpha = 1) {
    r /= 255;
    g /= 255;
    b /= 255;
    const max = Math.max(r, g, b);
...
export function rgbToOklch(r, g, b, alpha = 1) {
