...
const [originPackageJson, projectPackageJson,] = await Promise.all([
    await fileman.read.json(originPackagePath),
    await fileman.read.json(projectPackagePath),
]);
...
const rootPackageEssential = {
    bin: typeof originPackageJson.data.bin === "object" ?
        Object.keys(originPackageJson.data.bin)[0] : "",
