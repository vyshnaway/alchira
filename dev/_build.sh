...
GOOS=linux GOARCH=amd64 go build -ldflags='-s -w' -o ../binaries/linux-amd64

echo "Building for Linux (ARM64)..."
# Build for Linux ARM64, stripping debug information
GOOS=linux GOARCH=arm64 go build -ldflags='-s -w' -o ../binaries/linux-arm64

echo "Building for Linux (ARMv7)..."
# Build for Linux ARMv7, stripping debug information
GOOS=linux GOARCH=arm go build -ldflags='-s -w' -o ../binaries/linux-armv7

echo "Building for Windows (AMD64)..."
# Build for Windows AMD64, stripping debug information
GOOS=windows GOARCH=amd64 go build -ldflags='-s -w' -o ../binaries/win-amd64.exe

echo "Building for Windows (ARM64)..."
# # Build for Windows AMD64, stripping debug information
GOOS=windows GOARCH=arm64 go build -ldflags='-s -w' -o ../binaries/win-arm64.exe

echo "Building for Windows (386)..."
# Build for Windows 386, stripping debug information
GOOS=windows GOARCH=386 go build -ldflags='-s -w' -o ../binaries/win-386.exe

echo "Building for macOS (AMD64)..."
# Build for macOS AMD64, stripping debug information
GOOS=darwin GOARCH=amd64 go build -ldflags='-s -w' -o ../binaries/darwin-amd64

echo "Building for macOS (ARM64 - Apple Silicon)..."
# Build for macOS ARM64, stripping debug information
GOOS=darwin GOARCH=arm64 go build -ldflags='-s -w' -o ../binaries/darwin-arm64
