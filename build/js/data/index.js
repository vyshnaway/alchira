...
let NOW = 0;
const BIN = new Set();
export function FETCH(index) {
    return CACHE.CLASS.Index_to_Data[String(index)];
}
export function DECLARE(object) {
...
export function DISPOSE(...indexes) {
...
export function FIND(classname, localmap = {}) {
    let index = 0;
    let group = _Style._Type.NULL;
