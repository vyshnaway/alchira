...
// console.log(symKey)
const gen = await krypt.sym.gencrypt(JSON.stringify([
    [1, 2, 3],
    [4, 5, 6],
]));
console.log(gen);
...
console.log(Edec);
const enc = await krypt.sym.encrypt(JSON.stringify([
    [1, 2, 3],
    [4, 5, 6],
]), gen.key, gen.iv);
console.log(enc);
...
console.log(asymKey);
const asEnc = await krypt.asym.encrypt(JSON.stringify([
    [1, 2, 3],
    [4, 5, 6],
]), asymKey.publicKey);
console.log(asEnc);
...
console.log(asDec);
//# sourceMappingURL=kryptic.test.js.map