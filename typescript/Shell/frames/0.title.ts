...
import { blockType } from '../4.write';

export default function generateTitle(string: string): string[] {
    const padBothSides = (str: string, totalLength: number): string => {
    ...
    const modifyString = (str: string): string => {
